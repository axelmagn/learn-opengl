...
class Camera {
  public:
    ...
    glm::mat4 GetViewMatrix() {
        ...
        // manual implementation of LookAt as exercise
        glm::mat4 lookAtL = glm::mat4(1.f);
        lookAtL[0][0] = Right[0];
        lookAtL[1][0] = Right[1];
        lookAtL[2][0] = Right[2];
        lookAtL[0][1] = Up[0];
        ...
        lookAtL[1][2] = -Front[1];
        lookAtL[2][2] = -Front[2];
        // lookAtL = glm::transpose(lookAtL);

        glm::mat4 lookAtR = glm::mat4(1.f);
        lookAtR[3][0] = -Position[0];
        lookAtR[3][1] = -Position[1];
        lookAtR[3][2] = -Position[2];

        return lookAtL * lookAtR;
    ...
    void ProcessKeyboard(Camera_Movement direction, float deltaTime) {
        ...
        glm::vec3 front2d = Front;
        front2d.y = 0;
        front2d = glm::normalize(front2d);
        glm::vec3 right2d = glm::normalize(glm::cross(front2d, WorldUp)); 
